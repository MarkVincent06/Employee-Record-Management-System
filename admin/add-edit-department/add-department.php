...
<head>
    ...
    <!-- ADD DEPT VALIDATION JS -->
    <script src="js/add-dept-validation.js"></script>
        ...
        <div class="dashboard-content">
            ...
            <div class="form-wrapper">
                ...
                <div class="form-control">
                    ...
                    <textarea name="dept-desc" id="dept-desc" cols="30" rows="4" placeholder="Short description about the department..."></textarea>
                    <div class="validation">
                            <i class="fa-solid fa-circle-exclamation"></i>
                            <small></small>
                    </div>
